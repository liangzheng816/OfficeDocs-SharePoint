...
For more information, see [Reporting Services Report Server (SharePoint Mode)](/sql/reporting-services/report-server-sharepoint/reporting-services-report-server-sharepoint-mode?view=sql-server-2016&form=MG0AV3), [Reporting Services Report Server](/sql/reporting-services/reporting-services-concepts-ssrs?view=sql-server-ver16&formCode=MG0AV3), and [PowerShell cmdlets for Reporting Services SharePoint Mode](/sql/reporting-services/report-server-sharepoint/powershell-cmdlets-for-reporting-services-sharepoint-mode).
