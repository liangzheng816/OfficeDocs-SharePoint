...
Copilot uses the data stored in SharePoint and OneDrive sites to provide insights and automate tasks across your organization. Confidential data from content in SharePoint and OneDrive sites can populate in Copilot's generated insights, posing security and privacy risks.
...
- **Site Lifecycle Policy**
  ...
  - Inactive SharePoint sites policy
    - Read-only sites
    - Archived sites
  - Site Ownership Policy (available for **[Copilot licensed organizations](/sharepoint/advanced-management)** as of 30th May 2025)
