...
**18. I have chosen not to enable M365 Archive, what will happen to my unlicensed OneDrive accounts?**

**Answer:** Enabling M365 Archive has no impact on the enforcement of unlicensed OneDrive accounts. Unlicensed OneDrive accounts will get enforced no matter what, including being put into read-only mode and eventually Archive.  You can decide whether you want to enable billing for unlicensed OneDrive accounts, but you cannot prevent their archival.  M365 Archive and unlicensed OneDrive billing are two independent enablement toggles in the M365 admin center and have no effect on each other.  The enforcement flow for unlicensed accounts when M365 Archive is enabled or disabled is identical and outlined fully in this article. 
