...
Answer: All accessible files and folders within a Google user (Personal Drive or Shared Drive) are copied. Any items the user does not have permission to access will be excluded from the migration.
