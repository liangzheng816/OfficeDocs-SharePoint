...
description: Describing how to use Certificate Based Authentication in SharePoint migration.
author:      zacsun-ms
ms.author:   zhaosu
manager:     dapodean
ms.reviewer: heidip
...
- "Sorry, you can’t create this site. Enter a different SharePoint site URL or contact your administrator" if the target site doesn't exist.
