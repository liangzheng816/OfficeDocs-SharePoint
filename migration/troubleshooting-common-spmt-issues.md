...
|Migrate term store failed due to default term store does not exist. |There isn't a default site collection term store at SharePoint Server on-premises. |Go to SharePoint Server's Central Administration site, manage service application under Application Management, and edit the properties of the Managed Metadata Service Connection. Select the **This service application is the default storage location for column specific term sets** option. |
