...
|To update web navigation settings, you need following permissions: *Add and Customize Pages*. |The SharePoint account used for migration doesn't have permission to edit site navigation settings.|Grant the "Add and Customize Pages" permission to this account. |
