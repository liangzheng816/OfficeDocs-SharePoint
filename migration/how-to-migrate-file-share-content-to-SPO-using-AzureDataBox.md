...
> [!IMPORTANT]
> - Several factors impact the speed at which data is ingested into SharePoint, regardless if you have your data already in Azure. Understanding these factors helps you plan and your migration and maximize efficiency. For more info, see [SharePoint and OneDrive Migration Speed](./sharepoint-online-and-onedrive-migration-speed.md).
