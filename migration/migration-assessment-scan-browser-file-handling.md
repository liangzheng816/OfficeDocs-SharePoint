...
|DistinctUsers           |Number of distinct users who have accessed the site collection. Relies on data from the usage logging service. This row shows N/A if the usage logging service is disabled. |
