...
If you remove or corrupt the ScanDef.json file, a default configuration embedded in the SMAT.exe executable file is used instead. This change is noted in the SMAT.log file. If you disable a scan or change a property and notice that the change isn't picked up when you run SMAT.exe, look in the SMAT.log file for details.
