...
description: Learn about how Migration Manager estimates the length of time your migration project takes to complete.
---
...
>[!Important]
>It's important to recognize that the generated estimations are **preliminary** and based on big date fitting. They may vary due to individual factors, including, but not limited to:
>
...
- After connecting to the source, run an overall scan to attain a more precise estimate, which is displayed in the Migrations section.
