...
The sheet scan is turned off by default. Once you enable it in project settings, it automatically runs as part of the general scan process.
...
3. If access isn't granted, select **Grant access** at the top of the page to grant access.
4. Once access is granted, Migration Manager can run sheet scans for Google Sheets spreadsheet files.
...
|:-------------|:---------------------------------|:---------------------------|:----------------|:------------------|
|Sheet Summary  |Download report – Sheet summary  |Can select up to 1,000 tasks |SheetSummary.csv |A summary of Google Sheets of each selected task. |
