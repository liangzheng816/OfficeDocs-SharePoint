...
Answer: All accessible files and folders within a Dropbox user (Member folder or Team folder) are copied. Any items the user does not have permission to access will be excluded from the migration.
